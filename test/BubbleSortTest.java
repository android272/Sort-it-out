...
public class BubbleSortTest {
    ...
    @Test
    public void When_Optimized_Bubble_Sort_Is_Passed_A_Sorted_Array_It_Returns_An_Descending_Sorted_Array() {
        assertArrayEquals(new int[]{2, 1}, BubbleSort.sortDescendingOptimized(new int[] {2, 1}));
        assertArrayEquals(new int[]{3, 2, 1}, BubbleSort.sortDescendingOptimized(new int[] {3, 2, 1}));
        assertArrayEquals(new int[]{4, 3, 2, 1}, BubbleSort.sortDescendingOptimized(new int[] {4, 3, 2, 1}));
    }

    @Test
    public void When_Optimized_Bubble_Sort_Is_Passed_An_Unsorted_Array_It_Returns_An_Descending_Sorted_Array() {
        assertArrayEquals(new int[]{2, 1}, BubbleSort.sortDescendingOptimized(new int[] {1, 2}));
        assertArrayEquals(new int[]{3, 2, 1}, BubbleSort.sortDescendingOptimized(new int[] {1, 3, 2}));
        assertArrayEquals(new int[]{4, 3, 2, 1}, BubbleSort.sortDescendingOptimized(new int[] {1, 3, 2, 4}));
    }
}